                            ...
                            <table
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Please
                                            verify your email to activate your account.</h1>
                                        <a
                                        ...
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Use this otp to verify {{ $email }} within {{ date('d-m-Y h:i a', strtotime($expire)) }}
                                        </p>
                                    </td>
                                </tr>
                                <tr>
