...
Route::prefix('auth')->group(function () {
	...
	Route::post('sign-in', [LoginController::class, 'login']);    Route::post('forgot-password', [ForgotPassController::class, 'forgotPass']);
...
Route::post('/auth/verify-reset-otp', [ForgotPassController::class, 'verifyResetOtp']);
